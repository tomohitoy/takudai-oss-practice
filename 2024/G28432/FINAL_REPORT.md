...
　2030年度の教員の数も表を見ることであまり増減はないと考えられるため、このアプリケーションをリリースする際には、ターゲットユーザの人数はあまり変わりないと思われます。
...
　採点プリケーションを作るため、統計、データ分析を得意とするpythonで構成しようと考えています。
　文字認識のオープンソースソフトウェアについては、paddleOCRの採用を考えています。
